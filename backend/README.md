...
## Project Structure
    ...
    ├── testapiautocatalog_115656  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_115656`
...
2. Clone this repo and `cd testapiautocatalog_115656`
